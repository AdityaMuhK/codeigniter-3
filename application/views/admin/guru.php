                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left border border-black p-2 border-4">Foto Guru</th>
                                <th class="text-left border border-black p-2 border-4">Nama Guru</th>
                                <th class="text-left border border-black p-2 border-4">NIK</th>
                                <th class="text-left border border-black p-2 border-4">Gender</th>
                                <th class="text-left border border-black p-2 border-4">Mapel</th>
                        ...
                        <tbody>
                            ...
                            foreach ($guru as $row):
                                ...
                                <tr>
                                    ...
                                    <td class="border border-black p-2 border-4">
                                        <img src="<?php echo base_url('images/guru/' . $row->foto) ?>" width="50"
                                            height="50" alt="Foto Guru">
                                    </td>
                                    <td class="border border-black p-2 border-4">
